    ...
    <div className={cn("flex py-1", isUser ? "justify-end px-4" : "px-4")}>
      {isUser ? (
        <div className="max-w-[75%]">
          <div className="text-white px-4 py-2.5 rounded-2xl rounded-tr-sm text-sm leading-relaxed bg-judicial-navy">
            {message.content}
          </div>
...
export function ChatTab() {
  ...
  const { sessions, loading, error, selectedId, messages, messagesLoading, selectSession } = useHistory();
