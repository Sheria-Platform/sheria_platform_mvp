...
import { SessionSummary, MessageRecord, VerificationActivity, PredictionActivity, RiskLevel } from "@/types/api";
  ...
  return (
    <div className="border-b last:border-0">
      <button
        ...
        onClick={() => setExpanded((v) => !v)}
      >
        <TrendingUp size={15} className="text-[#1a3a6b] shrink-0 opacity-70" />
